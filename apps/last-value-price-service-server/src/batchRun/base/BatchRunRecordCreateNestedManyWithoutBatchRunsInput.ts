...
@InputType()
class BatchRunRecordCreateNestedManyWithoutBatchRunsInput {
...
export { BatchRunRecordCreateNestedManyWithoutBatchRunsInput as BatchRunRecordCreateNestedManyWithoutBatchRunsInput };
